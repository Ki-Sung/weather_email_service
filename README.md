...
- 이 소프트웨어와 관련 문서 파일의 복사본을 취득하는 모든 사용자에게 아무런 제한 없이 프로그램을 사용, 복사, 수정, 병합, 출판, 배포, 서브라이선스 설정 및 판매할 권리를 무료로 부여합니다.
- 이 소프트웨어는 "있는 그대로" 제공되며, 어떠한 종류의 명시적이거나 묵시적인 보증도 하지 않습니다.
- 어떠한 경우에도 저자 또는 저작권 소유자는 소프트웨어의 사용 또는 기타 취급으로 인해 발생하는 모든 청구, 손해 또는 기타 책임에 대해 책임을 지지 않습니다.
